...
fn format_operand(operand: &OperandPlan) -> String {
    match operand {
        ...
        OperandPlan::ImmI64(value) => format!("i64:{value}"),
        OperandPlan::ImmF32(bits) => format!("f32:{}", f32::from_bits(*bits)),
        OperandPlan::ImmF64(bits) => format!("f64:{}", f64::from_bits(*bits)),
...
fn format_opcode(opcode: Opcode) -> &'static str {
    match opcode {
        ...
        Opcode::NeI64 => "ne_i64",
        Opcode::LtI64 => "lt_i64",
        Opcode::LoadI64 => "load_i64",
        Opcode::StoreI64 => "store_i64",
        Opcode::ConstF32 => "const_f32",
