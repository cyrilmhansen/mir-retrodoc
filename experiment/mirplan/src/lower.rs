...
fn lower_operand(operand: &OperandPlan) -> LoweredOperand {
    match operand {
        ...
        OperandPlan::ImmF32(value) => LoweredOperand::ImmF32(*value),
        OperandPlan::ImmF64(value) => LoweredOperand::ImmF64(*value),
